...
export const metadata: Metadata = {
  title: "Luxury Hotel - Unparalleled Hospitality",
  description: "Experience unparalleled luxury at our hotel, offering the finest suites and services.",
  keywords: "luxury hotel, accommodations, rooms, hotel spa",
  openGraph: {
    title: "Luxury Hotel - Unparalleled Hospitality",
    description: "Experience unparalleled luxury at our hotel, offering the finest suites and services.",
    siteName: "Hotel Name",
